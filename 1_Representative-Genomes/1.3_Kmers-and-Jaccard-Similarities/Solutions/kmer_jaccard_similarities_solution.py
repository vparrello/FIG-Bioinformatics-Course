...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Usage: python kmer_jaccard_similarities.py <k> <fasta_file>")
    parser.add_argument("-K", "--Kmer", type=int, required=True, help="Length of the Kmer")
    parser.add_argument("-f", "--fasta_file", type=str, required=True, help="Path to the FASTA file")
...
if __name__ == "__main__":
    ...
    if args.Kmer <= 0:
        ...
        sys.exit(1)
    main(args.Kmer, args.fasta_file)
